...
raw_dataset = datasets.load_from_disk(
    "/home/penguin/GeorgianWritingWizard/language_engine/examples/filtered_data"
)
...
new_tok.save_pretrained(
    "/home/penguin/GeorgianWritingWizard/language_engine/examples/ff_tok"
)
