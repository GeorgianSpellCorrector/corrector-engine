...
dataset = load_dataset(
    ...
    data_files={
        "train": [
            "/home/penguin/GeorgianWritingWizard/data/whole_corpus/filter_v2/filtered.txt"
        ]
    },
)
# dataset = load_dataset('ZurabDz/geo_small_corpus')

tokenized_dataset = huggingface_preprocessing(
    dataset["train"], tokenizer, NUM_THREADS, max_seq_length=128
)
